...
<html lang="en">
  ...
  <body class="">
    <div class="page" style="background: url('/assets/images/stocks/background.png') center center fixed no-repeat; background-size: cover; padding: 2.5rem 1rem 0 1rem;">
      <div class="page-main">
                ...
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      ...
                      <img src="/assets/images/icons/journal.svg" width="70">
                    </div>
              ...
              <div class="col-md-3">
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      <small class="text-muted"><i class="fa fa-cloud-upload-alt fa-fw"></i> 24 March 2018</small>
                      <img src="/assets/images/icons/proceeding.svg" width="70">
                    </div>
              ...
              <div class="col-md-3">
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      <small class="text-muted"><i class="fa fa-cloud-upload-alt fa-fw"></i> 24 March 2018</small>
                      <img src="/assets/images/icons/citation.svg" width="70">
                    </div>
              ...
              <div class="col-md-3">
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      <small class="text-muted"><i class="fa fa-cloud-upload-alt fa-fw"></i> 24 March 2018</small>
                      <img src="/assets/images/icons/book.svg" width="70">
                    </div>
              ...
              <div class="col-md-3">
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      <small class="text-muted"><i class="fa fa-cloud-upload-alt fa-fw"></i> 24 March 2018</small>
                      <img src="/assets/images/icons/copyright.svg" width="70">
                    </div>
              ...
              <div class="col-md-3">
                <div class="card h-100" style="border-radius: 1rem">
                  <div class="card-body">
                    <div class="text-left d-flex justify-content-between">
                      <small class="text-muted"><i class="fa fa-cloud-upload-alt fa-fw"></i> 24 March 2018</small>
                      <img src="/assets/images/icons/account.svg" width="70">
                    </div>
